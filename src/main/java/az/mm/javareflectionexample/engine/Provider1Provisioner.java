 ...
 */
public class Provider1Provisioner implements ProvisioningEngine {

    private static volatile Provider1Provisioner instance;

    private Provider1Provisioner(){}

    public static Provider1Provisioner getInstance() {
        if (instance == null)
            synchronized (Provider1Provisioner.class) {
                if (instance == null) instance = new Provider1Provisioner();
            }
        return instance;
    }
